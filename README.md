...
- 🤖 **KI-Analyse** – Optionale Anbindung an OpenAI (GPT-4o), Anthropic (Claude 3.5) oder Google (Gemini 2.0) für smarte Benennungen und Beschreibungen
...
| **Gemini 2.0 Flash** | Sehr gut | Kostenlos (Limit) | ✅ |
